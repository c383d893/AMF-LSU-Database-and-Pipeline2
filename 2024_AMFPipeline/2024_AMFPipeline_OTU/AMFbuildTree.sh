...
OTU_REPSEQ_FILE="./BLAST_otu97repseqs_clean_aligned.fasta" # representative sequences of filtered 97% OTUs (generated by AMFtrimmedToOTUs.sh), aligned to ref db
...
raxmlHPC-PTHREADS-AVX -f d -m GTRGAMMA -p 1723 -N 100 -r Root_v16_LSUDB-1000BS-GTRGAMMA-bootstrap-tree.newick -s $TMP_SEQ -n ${SLURM_ARRAY_TASK_ID}_AMFtree.ENVbackbone -T 16 -w $RAxMLoutpath
