...
awk "/^>/ {n++} n>207 {exit} {print}" ./aligned_BLAST_otu97plusv16_2024_cut.fasta > ./v16_LSUDB_2024_cut_aligned.fasta

#extract study sequences

grep -A 15 ">OTU" ./aligned_BLAST_otu97plusv16_2024_cut.fasta > ./BLAST_otu97repseqs_clean_aligned.fasta
