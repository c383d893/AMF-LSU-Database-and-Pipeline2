...
writeXStringSet(forwardread, "R1.BLAST_ASVplusV15_3.23.21_cut.fasta",width=10000) #write out.
...
writeXStringSet(reverseread, "R2.BLAST_ASVplusV15_3.23.21_cut.fasta",width=10000) #write out.
