...
writeXStringSet(forwardread, "R1.BLAST_ASVplusV18_052025_cut.fasta",width=10000) #write out.
...
writeXStringSet(reverseread, "R2.BLAST_ASVplusV18_052025_cut.fasta",width=10000) #write out.
