...
writeXStringSet(forwardread, "R1.BLAST_ASVplusV16_2024_cut.fasta",width=10000) #write out.
...
writeXStringSet(reverseread, "R2.BLAST_ASVplusV16_2024_cut.fasta",width=10000) #write out.
