...
awk "/^>/ {n++} n>207 {exit} {print}" ./aligned_BLAST_ASVplusv16_2024_cut.fasta > ./v16_LSUDB_2024_cut_aligned.fasta

#extract study sequences

grep -A 15 ">ASV" ./aligned_BLAST_ASVplusv16_2024_cut.fasta > ./BLAST_ASVrepseqs_clean_aligned.fasta
