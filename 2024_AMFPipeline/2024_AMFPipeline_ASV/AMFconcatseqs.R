...
SeqstoAlign <- readDNAStringSet('BLAST_ASVplusV16_2024_cut.fasta')
...
forward.aligned <- readDNAStringSet('R1.BLAST_ASVplusV16_2024_cut_out/aligned-dna-sequences.fasta')
reverse.aligned <- readDNAStringSet('R2.BLAST_ASVplusV16_2024_cut_out/aligned-dna-sequences.fasta')
...
writeXStringSet(joined.aligned, "aligned_BLAST_ASVplusV16_2024_cut.fasta",width=10000) #write out.
