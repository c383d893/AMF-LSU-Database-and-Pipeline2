...
# Fixed:
# 1. single alignment 
# 2. alignment R1 and R2 separately
# 3. extra chimera removal step
# 4. improved backbone tree
...
./AMFAlignseqs.sh # align sequence to database sequences
