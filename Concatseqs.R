...
SeqstoAlign <- readDNAStringSet('otu97plusV15_3.23.21_cut.fasta')
...
forward.aligned <- readDNAStringSet('R1.otu97plusV15_3.23.21_cut_out/aligned-dna-sequences.fasta')
reverse.aligned <- readDNAStringSet('R2.otu97plusV15_3.23.21_cut_out/aligned-dna-sequences.fasta')
...
writeXStringSet(joined.aligned, "aligned_otu97plusV15_3.23.21_cut.fasta",width=10000) #write out.
