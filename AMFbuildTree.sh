...
echo "debug1"
nSeqsPerSubset=1 # divide the input fasta into subsets with this number of sequences ?
OTU_REPSEQ_FILE="./otu97repseqs_clean_aligned.fasta" # representative sequences of filtered 97% OTUs (generated by AMFtrimmedToOTUs.sh), aligned to ref db
...
raxmlHPC-PTHREADS-AVX -f d -m GTRGAMMA -p 1723 -N 10 -r Root_V15_LSUDB-1000BS-GTRGAMMA-bootstrap-tree.newick -s $TMP_SEQ -n ${SLURM_ARRAY_TASK_ID}_AMFtree.ENVbackbone -T 16 -w $RAxMLoutpath
