...
awk "/^>/ {n++} n>207 {exit} {print}" ./aligned_otu97plusV15_3.23.21_cut.fasta > ./V15_LSUDB_3.23.21_cut_aligned.fasta

#extract study sequences

grep -A 1 ">OTU" ./aligned_otu97plusV15_3.23.21_cut.fasta > ./otu97repseqs_clean_aligned.fasta

nSeqsPerSubset=1 # divide the input fasta into subsets with this number of sequences ?
OTU_REPSEQ_FILE="./otu97repseqs_clean_aligned.fasta" # representative sequences of filtered 97% OTUs (generated by AMFtrimmedToOTUs.sh)
