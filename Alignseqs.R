...
writeXStringSet(forwardread, "R1.otu97plusV15_3.23.21_cut.fasta",width=10000) #write out.
...
writeXStringSet(reverseread, "R2.otu97plusV15_3.23.21_cut.fasta",width=10000) #write out.
