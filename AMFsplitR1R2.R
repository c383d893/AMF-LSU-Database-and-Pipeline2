...
SeqstoSplit <- readDNAStringSet('otu97repseqs_clean.fasta')
...
writeXStringSet(forwardread, "R1.otu97repseqs_clean.fasta",width=10000) #write out.
...
writeXStringSet(reverseread, "R2.otu97repseqs_clean.fasta",width=10000) #write out.
